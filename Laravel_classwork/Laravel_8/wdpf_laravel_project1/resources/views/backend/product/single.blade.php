...
<div class="nk-content-body">
                ...
                <div class="row pb-5">
                    <div class="col-lg-6">
                        <div class="product-gallery me-xl-1 me-xxl-5">
                            <img src="{{'product_photos/'.$product->product_img}}" class="rounded" alt="">
    ...
    "responsive":[ {"breakpoint": 1539,"settings":{"slidesToShow": 4}}, {"breakpoint": 768,"settings":{"slidesToShow": 3}}, {"breakpoint": 420,"settings":{"slidesToShow": 2}} ]
                                ...
                                <div class="slider-item">
                                    <div class="thumb">
                                        <img src="{{$product->product_img}}" class="rounded" alt="">
                                    </div>
                                </div>
                            </div><!-- .slider-nav -->
                        </div><!-- .product-gallery -->
                    ...
                    <div class="col-lg-6">
                        <div class="product-info mt-5 me-xxl-5">
                            <h4 class="product-price text-primary">{{$product->product_price}}Tk. <small class="text-muted fs-14px"> Stock{{$product->product_stock}}$98.00</small></h4>
                            ...
                            <div class="product-excrept text-soft">
                                <p class="lead">{{$product->product_descriptions}}</p>
                            </div>
        ...
        <div class="slider-init row" data-slick='{"slidesToShow": 4, "centerMode": false, "slidesToScroll": 1, "infinite":false, "responsive":[ {"breakpoint": 1540,"settings":{"slidesToShow": 3}},{"breakpoint": 992,"settings":{"slidesToShow": 2}}, {"breakpoint": 576,"settings":{"slidesToShow": 1}} ]}'>
            <div class="col">
                <div class="card card-bordered product-card">
                    ...
                    <div class="card-inner text-center">
                        ...
                        <div class="product-price text-pri
                        
                        
                        mary h5"><small class="text-muted del fs-13px">$350</small> $324</div>
                    </div>
                </div>
            </div><!-- .col -->
            <div class="col">
            ...
            <div class="col">
                <div class="card card-bordered product-card">
                    <div class="product-thumb">
                        <a href="html/product-details.html">
                            <img class="card-img-top" src="{{'product_photos/'.$product->product_img}}" alt="">
                        </a>
                        <ul class="product-actions">
                            <li><a href="#"><em class="icon ni ni-cart"></em></a></li>
                            <li><a href="#"><em class="icon ni ni-heart"></em></a></li>
