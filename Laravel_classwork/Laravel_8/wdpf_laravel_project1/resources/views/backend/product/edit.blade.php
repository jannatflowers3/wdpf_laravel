                                ...
                                <div class="nk-block-head nk-block-head-sm">
                                    <div class="nk-block-between">
                                        <div class="nk-block-head-content">
                                            <h3 class="nk-block-title page-title">Edit Products</h3>
                                        ...
                                        <div class="row g-3">
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <div class="form-control-wrap">
                                                        ...
                                                        cols="36" rows="10">
                                                 {{old('product_descriptions') ?old('product_descriptions'):$product->product_descriptions}}
                                                        </textarea>
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="form-control-wrap">
                                                        <input type="number" class="form-control"
                                                         value="{{old('product_price') ?old('product_price'):$product->product_price}}" id="product_price" name="product_price">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <div class="form-control-wrap">
                                                        <input type="number" class="form-control"
                                                         value="{{old('product_stock') ? old('product_stock'):$product->product_stock}}" id="product_stock" name="product_stock">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-12">
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <img src="/product_photos/{{$product->product_img}}" width="120px" />
                                                    </div>
                                                </div>
